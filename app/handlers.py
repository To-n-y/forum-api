...
def post_create(topic_name=Form(), user_id=Form(), database=Depends(connect_db), request: Request = None):
...
def user_create_sign(user_password=Form(), user_name=Form(), database=Depends(connect_db), request: Request = None):
...
def user_create_post(user_email=Form(), user_password1=Form(), user_password2=Form(), user_name=Form(),
                     user_surname=Form(),
                     database=Depends(connect_db), request: Request = None):
